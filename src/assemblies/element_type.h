...
namespace stereo {
    namespace assemblies {
        ...
        enum class ElementType : u8
        {
            ...
            Boxed = 0x51,               // Used in custom attributes to specify a boxed object (§II.23.3).
            Reserved= 0x52,
            FieldInd = 0x53,            // Used in custom attributes to indicate a FIELD(§II.22.10, II.23.3).
            PropInd = 0x54,             // Used in custom attributes to indicate a PROPERTY(§II.22.10, II.23.3).
